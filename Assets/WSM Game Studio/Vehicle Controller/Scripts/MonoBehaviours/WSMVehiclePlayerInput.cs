    ...
    public class WSMVehiclePlayerInput : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (enablePlayerInput)
            {
                ...
                _acceleration = (Input.GetKey(inputSettings.acceleration) || (arduinoInput == "Z")) ? 1f : 0;
                _acceleration = (Input.GetKey(inputSettings.reverse) || (arduinoInput == "S")) ? _acceleration - 1 : _acceleration;
                _vehicleController.AccelerationInput = _acceleration;

                _steering = 0f;
                _steering = (Input.GetKey(inputSettings.turnRight) || (arduinoInput == "D")) ? _steering + 1 : _steering;
                _steering = (Input.GetKey(inputSettings.turnLeft) || (arduinoInput == "Q")) ? _steering - 1 : _steering;
                ...
                if (Input.GetKey(inputSettings.toggleEngine) || arduinoInput == "T")
